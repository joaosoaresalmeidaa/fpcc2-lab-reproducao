...
calculate_and_print_bleu_stats <- function(reference_data, candidate_data) {
  ...
  return(list(media = average_bleu, mediana = median_bleu, desvio_padrao = sd_bleu))
}
```
...
```{r}
# Cria um data frame com as estatísticas
df <- data.frame(Estatistica = c("Média", "Mediana", "Desvio Padrão"),
                 Valor = unlist(bleu_stats_k1))

# Plotar o gráfico de barras
ggplot(df, aes(x = Estatistica, y = Valor)) +
  geom_bar(stat = "identity", fill = "orange") +
  labs(x = "", y = "Valor", title = "K1 (1-encoder)") +
  ylim(0, 1) +
  theme_minimal() +
...
# Cria um data frame com as estatísticas
df <- data.frame(Estatistica = c("Média", "Mediana", "Desvio Padrão"),
                 Valor = unlist(bleu_stats_k1_2))

# Plotar o gráfico de barras
ggplot(df, aes(x = Estatistica, y = Valor)) +
  geom_bar(stat = "identity", fill = "orange") +
  labs(x = "", y = "Valor", title = "K1 (2-encoder)") +
  ylim(0, 1) +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
# Cria um data frame com as estatísticas
df <- data.frame(Estatistica = c("Média", "Mediana", "Desvio Padrão"),
                 Valor = unlist(bleu_stats_k3_2))

# Plotar o gráfico de barras
ggplot(df, aes(x = Estatistica, y = Valor)) +
  geom_bar(stat = "identity", fill = "orange") +
  labs(x = "", y = "Valor", title = "K3 (2-encoder)") +
  ylim(0, 1) +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
# Cria um data frame com as estatísticas
df <- data.frame(Estatistica = c("Média", "Mediana", "Desvio Padrão"),
                 Valor = unlist(bleu_stats_k5_2))

# Plotar o gráfico de barras
ggplot(df, aes(x = Estatistica, y = Valor)) +
  geom_bar(stat = "identity", fill = "orange") +
  labs(x = "", y = "Valor", title = "K5 (2-encoder)") +
  ylim(0, 1) +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
# Cria um data frame com as estatísticas
df <- data.frame(Estatistica = c("Média", "Mediana", "Desvio Padrão"),
                 Valor = unlist(bleu_stats_k10_2))

# Plotar o gráfico de barras
ggplot(df, aes(x = Estatistica, y = Valor)) +
  geom_bar(stat = "identity", fill = "orange") +
  labs(x = "", y = "Valor", title = "K10 (2-encoder)") +
  ylim(0, 1) +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k1)

ggplot(df, aes(x = Index, y = Similaridade)) +
  geom_point(size = 3) +
  labs(x = "Amostra K1 (1-encoder)", y = "Similaridade") +
  ggtitle("Gráfico de Dispersão de Similaridade (Levenshtein)") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
...
```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k3)

ggplot(df, aes(x = Index, y = Similaridade)) +
  geom_point(size = 3) +
  labs(x = "Amostra K3 (1-encoder)", y = "Similaridade") +
  ggtitle("Gráfico de Dispersão de Similaridade (Levenshtein)") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k5)

ggplot(df, aes(x = Index, y = Similaridade)) +
  geom_point(size = 3) +
  labs(x = "Amostra K5 (1-encoder)", y = "Similaridade") +
  ggtitle("Gráfico de Dispersão de Similaridade (Levenshtein)") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k10)

ggplot(df, aes(x = Index, y = Similaridade)) +
  geom_point(size = 3) +
  labs(x = "Amostra K10 (1-encoder)", y = "Similaridade") +
  ggtitle("Gráfico de Dispersão de Similaridade (Levenshtein)") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
similarity_k1_2_encoder <- calculate_similarity(data_k1_raw_2, data_k1_abstract_2, sample_size)
print(paste("Tivemos", round(similarity, 2), "% de similaridade. | (data_k1_raw_2, data_k1_abstract_2)"))
```

```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k1_2_encoder)

ggplot(df, aes(x = Index, y = Similaridade)) +
  geom_point(size = 3) +
  labs(x = "Amostra K1 (2-encoder)", y = "Similaridade") +
  ggtitle("Gráfico de Dispersão de Similaridade (Levenshtein)") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
similarity_k3_2_encoder <- calculate_similarity(data_k3_raw_2, data_k3_abstract_2, sample_size)
print(paste("Tivemos", round(similarity, 2), "% de similaridade. | (data_k3_raw_2, data_k3_abstract_2)"))
```

```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k3_2_encoder)

ggplot(df, aes(x = Index, y = Similaridade)) +
  geom_point(size = 3) +
  labs(x = "Amostra K10 (2-encoder)", y = "Similaridade") +
  ggtitle("Gráfico de Dispersão de Similaridade (Levenshtein)") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
similarity_k5_2_encoder <- calculate_similarity(data_k5_raw_2, data_k5_abstract_2, sample_size)
print(paste("Tivemos", round(similarity, 2), "% de similaridade. | (data_k5_raw_2, data_k5_abstract_2)"))
```

```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k5_2_encoder)

ggplot(df, aes(x = Index, y = Similaridade)) +
  geom_point(size = 3) +
  labs(x = "Amostra K5 (2-encoder)", y = "Similaridade") +
  ggtitle("Gráfico de Dispersão de Similaridade (Levenshtein)") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
similarity_k10_2_encoder <- calculate_similarity(data_k10_raw_2, data_k10_abstract_2, sample_size)
print(paste("Tivemos", round(similarity, 2), "% de similaridade. | (data_k10_raw_2, data_k10_abstract_2)"))
```

```{r}
# Criando um data frame com os valores de similaridade e índices
df <- data.frame(Index = 1:sample_size, Similaridade = similarity_k10_2_encoder)
